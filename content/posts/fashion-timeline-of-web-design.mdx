...
1. I doubt there was this “standard” notion of cards as a way to layout content at this period, but there you go, If it ever was, this is how it could’ve looked. This is what I referred to as the [2000s system font times](https://frontendsucks.com/a-brief-history-of-web-typography#2000s-system-fonts).
...
3. This one maps to the [Google font beginning](https://frontendsucks.com/a-brief-history-of-web-typography#enter-google-fonts) with the flattening of web and UI in general. Pioneered by the Apple’s move from skeuomorphism to flat design (and thin typeface at the start).
...
5. Clearly this is [the new system font era](https://frontendsucks.com/a-brief-history-of-web-typography#system-fonts-strong-comeback). Cleanliness could be the title of this period. Almost like this: `system-ui, -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif` is the standard way to style fonts on the web.
